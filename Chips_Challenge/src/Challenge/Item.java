...
/**An item is used to help a player navigate throughout the level. It can be collected, has its own sprite and is either
 * consumable or is a permanent addition to the player's inventory.
 * @author Angelo
 * @version %I%
 */
